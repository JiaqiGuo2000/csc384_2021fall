...
if __name__ == '__main__':
    ...
    print(prob)
    co.set_evidence('YES')
    prob = VE(medical, ac, [bmi, co])
    print(prob)
    ht.set_evidence('YES')
    prob = VE(medical, ac, [bmi, co, ht])
    print(prob)
    gd.set_evidence('Female')
    prob = VE(medical, ac, [bmi, co, ht, gd])
    print(prob)
    ag.set_evidence('~60')
    prob = VE(medical, ac, [bmi, co, ht, gd, ag])
    print(prob)
    ...
    prob = VE(medical, db, [bmi])
    print(prob)
    co.set_evidence('NO')
    prob = VE(medical, db, [bmi, co])
    print(prob)
    ht.set_evidence('NO')
    prob = VE(medical, db, [bmi, co, ht])
    print(prob)
    gd.set_evidence('Female')
    prob = VE(medical, db, [bmi, co, ht, gd])
    print(prob)
    ag.set_evidence('<40')
    prob = VE(medical, db, [bmi, co, ht, gd, ag])
    print(prob)